  ...
  return (
    <div className="animate-slide-up stagger-1">
      ...
      <div className="grid grid-cols-3 gap-3">
        <button 
          onClick={onAddIncome}
          className="flex flex-col items-center gap-2 p-4 bg-card rounded-2xl shadow-card hover:shadow-elevated transition-all duration-200 active:scale-[0.98]"
        >
        ...
        >
          ...
          <span className="text-xs font-medium">Cash Check</span>
        </button>
      </div>
    </div>
  );
